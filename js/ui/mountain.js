  ...
  function create(canvas, bus) {
    ...
    function loadPalette() {
      pal = {
        ...
        midLo:        token('--mtn-mid-lo',        'rgba(127, 178, 229, 0.19)'),
        midHi:        token('--mtn-mid-hi',        'rgba(223, 234, 255, 0.46)'),
        dimLo:        token('--mtn-dim-lo',        'rgba(92, 134, 184, 0.14)'),
        dimHi:        token('--mtn-dim-hi',        'rgba(159, 192, 228, 0.28)'),
